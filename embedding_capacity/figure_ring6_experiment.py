...
def make_figure(data, out_path=os.path.join(HERE, 'figure_ring6_experiment.png')):
...
if __name__ == '__main__':
    ...
    ap.add_argument('--input', default=os.path.join(HERE, 'ring6_results.json'))
    ap.add_argument('--out',   default=os.path.join(HERE, 'figure_ring6_experiment.png'))
    args = ap.parse_args()
