...
def main():
    ...
    runs = [
        (P_C,       "critical",     os.path.join(FIGURES, "figure_poincare_percolation.png")),
        (0.5*P_C,   "subcritical",  os.path.join(FIGURES, "figure_poincare_percolation_subcritical.png")),
        (1.5*P_C,   "supercritical",os.path.join(FIGURES, "figure_poincare_percolation_supercritical1.png")),
        (2.5*P_C,   "supercritical",os.path.join(FIGURES, "figure_poincare_percolation_supercritical2.png")),
    ]
    meta = []
    for p, label, out_path in runs:
        meta.append(make_figure(G, tris, pos, p, label, out_path))

    with open(os.path.join(RESULTS, "poincare_percolation_meta.json"), "w") as f:
        json.dump({
