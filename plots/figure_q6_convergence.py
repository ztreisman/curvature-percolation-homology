...
def main(sweep_path=os.path.join(RESULTS, 'sweep_results.json'),
         extension_path=os.path.join(RESULTS, 'q6_convergence_results.json'),
         out_path=os.path.join(FIGURES, 'figure_q6_convergence.png')):
