...
def make_figure(results_sp, eigvals_sp, results_full,
                out_path='figure_hessian_spectrum.png'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--spring', default='hessian_spring_all.json')
    parser.add_argument('--full',   default='hessian_results.json')
    parser.add_argument('--out',    default='figure_hessian_spectrum.png')
